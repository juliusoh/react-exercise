...
const darkTheme = createTheme({
    ...
    MuiSwitch: {
      styleOverrides: {
        ...
        thumb: {
          ...
          border: `1px solid ${colors.alpha.black[30]}`,
          boxShadow:
            `0px 9px 14px ${colors.alpha.black[10]
            }, 0px 2px 2px ${colors.alpha.black[10]}`,
        },
        track: {
          backgroundColor: colors.alpha.black[5],
  ...
  colors: {
    ...
    shadows: {
      ...
      cardHover: colors.shadows.cardHover,
