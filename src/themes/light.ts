...
const colors = {
  ...
  shadows: {
    ...
    secondary: "0px 1px 4px rgba(85, 105, 255, 0.25), 0px 3px 12px 2px rgba(85, 105, 255, 0.35)",
  ...
  alpha: {
    white: {
      ...
      95: alpha(themeColors.white, 0.95),
...
const lightTheme = createTheme(
      ...
      MuiOutlinedInput: {
        styleOverrides: {
          root: {
            ...
            "&.Mui-focused.Mui-error:hover .MuiOutlinedInput-notchedOutline": {
              borderColor: colors.error.main,
            },
          },
        },
  ...
  },
  {
    ...
    header: {
      height: "80px",
      background: colors.alpha.white[95],
      boxShadow: colors.shadows.cardSm,
